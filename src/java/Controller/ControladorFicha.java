...
public class ControladorFicha extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        {
         acceso = agregarfi;
        }else if(action.equalsIgnoreCase("Agregarf"))
        {
            int codf = Integer.parseInt(request.getParameter("txtcodficha"));
            int numapre = Integer.parseInt(request.getParameter("txtnumapre"));
            int listapro = Integer.parseInt(request.getParameter("listapro"));
            int listapre = Integer.parseInt(request.getParameter("listapre"));

            f.setCodFicha(codf);
            f.setCantiaprendices(numapre);
            f.setCodaprendiz(listapro);
            f.setCodprograma(listapre);
